...
const FundCard = ({ owner, title, description, target, deadline, amountCollected, image, handleClick }: FundCardProps) => {
  ...
  const date = new Date(deadline * 1000).toLocaleDateString();
      ...
      <div className="flex flex-col p-4">
        ...
        <div className="flex justify-between flex-wrap mt-[15px] gap-2">
          ...
          <div className="flex flex-col">
            ...
            <p className="mt-[3px] font-epilogue font-normal text-[12px] leading-[18px] text-[#808191] sm:max-w-[120px] truncate">{date}</p>
